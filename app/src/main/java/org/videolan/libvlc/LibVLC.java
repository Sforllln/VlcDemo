...
public class    LibVLC {
    ...
    private int networkCaching = 400;
    private int clockJitter    = 400;
    private int previewTcp = 0;
    ...
    // RTSP TCP/UDP
    public int getPreviewTCP() {
    	SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(VLCApplication.getAppContext());
		Integer tcp = preferences.getInt("_rtsp_tcp", 0);
		Log.d("_rtsp_tcp","_rtsp_tcp" + tcp );
        return tcp;
    }

//    public void setPreviewTCP(int previewTcp) {
//       this.previewTcp = previewTcp;
//    }
    ...
    public native boolean toggleRecord(String path, String fileName) ;
